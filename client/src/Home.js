...
const Home = () => {
    ...
    return (
        ...
        <div className="Background">
               <center> 
                   <h1 className="cursive mt-5 text-light">Welcome to ICAL </h1>
                   
                   <div className="comforta mt-3 text-warning pl-3">ICAL is an E-Learning platform for students and faculties </div>
                   <div className="comforta text-warning p-2">With ICAL you can- </div>
